      ...
      <aside className="w-64 bg-[rgba(15,23,42,0.8)] border-r border-[rgba(255,255,255,0.05)] flex-shrink-0 flex flex-col h-screen sticky top-0">
        ...
        <nav className="p-4 flex-1 space-y-1 overflow-y-auto">
          <div className="px-4 py-2 mt-2 mb-1">
            <p className="text-xs font-semibold text-[#64748B] uppercase tracking-wider">Owner Menu</p>
          </div>
          {navItems.map((item) => (
            <Link
              key={item.href}
          ...
          <div className="px-4 py-2 mt-4 mb-1">
            <p className="text-xs font-semibold text-[#64748B] uppercase tracking-wider">Tenant Menu</p>
          </div>
